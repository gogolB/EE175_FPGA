...
set_clock_groups -asynchronous -group [get_clocks sysClk] -group [get_clocks ftdi_clk]
set_clock_groups -asynchronous -group [get_clocks ftdi_clk] -group [get_clocks sysClk]